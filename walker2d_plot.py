...
df0 = pd.read_csv(f"models/walker2d/[0.0001, 0.1]/v1/2021/eval_metrics0.csv")
df1 = pd.read_csv(f"models/walker2d/[0.0001, 0.1]/v1/2021/eval_metrics1.csv")
df0 = df0[df0["step"] <= 3000000]
df1 = df1[df1["step"] <= 3000000]
