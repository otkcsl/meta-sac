...
for idx, i in enumerate(save):
    df = pd.read_csv(f"models/humanoidstandup/{i}/v1/2021/eval_metrics.csv")
    ...
    # v2 のデータもあれば同様に処理
    if i == 0.05:
        df_v2 = pd.read_csv(f"models/humanoidstandup/{i}/v2/2021/eval_metrics.csv")
...
df0 = pd.read_csv(f"models/humanoidstandup/[0.0001, 0.1]/v1/2021/eval_metrics0.csv")
df1 = pd.read_csv(f"models/humanoidstandup/[0.0001, 0.1]/v1/2021/eval_metrics1.csv")
seeds = ["seed_2021", "seed_2022", "seed_2023", "seed_2024", "seed_2025"]
...
plt.legend()
plt.grid(True)
plt.savefig("humanoidstandup_plot.png")
