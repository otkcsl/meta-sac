...
# CSV読み込み
save = [0.00001, 0.0001, 0.01, 0.021418564021587372, 0.1, 0.2, 1.0]
...
for idx, i in enumerate(save):
    df = pd.read_csv(f"models/reacher/{i}/v1/2021/eval_metrics.csv")
    ...
    # v2 のデータもあれば同様に処理
    if i == 0.2:
        df_v2 = pd.read_csv(f"models/reacher/{i}/v2/2021/eval_metrics.csv")
...
df0 = pd.read_csv(f"models/reacher/[0.0001, 0.1]/v1/2021/eval_metrics0.csv")
df1 = pd.read_csv(f"models/reacher/[0.0001, 0.1]/v1/2021/eval_metrics1.csv")
df0 = df0[df0["step"] <= 250000]
df1 = df1[df1["step"] <= 250000]
